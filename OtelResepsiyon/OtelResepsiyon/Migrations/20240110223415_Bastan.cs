...
namespace OtelResepsiyon.Migrations
{
    /// <inheritdoc />
    public partial class Bastan : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YatakDuzeni = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Durum = table.Column<int>(type: "int", nullable: false),
                    BosOdaSayisi = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Odalar", x => x.OdaNo);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OdaTipi = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    OdaNo = table.Column<int>(type: "int", nullable: true),
                    Durum = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rezervasyonlar_Odalar_OdaNo",
                        column: x => x.OdaNo,
                        principalTable: "Odalar",
                        principalColumn: "OdaNo");
                });
